...
const mockAlertData = ref([
  {
    ...
    probeName: '北京',
    alertLevel: 'critical',
    content: 'HTTP请求超时，响应时间超过5000ms',
    created_at: '2025-08-21 14:30:00'
  },
  {
    id: 2,
    taskName: 'HTTP拨测任务1',
    probeName: '上海',
    alertLevel: 'warning',
    content: 'HTTP状态码异常，返回404',
    created_at: '2025-08-21 14:25:00'
  },
  {
    id: 3,
    taskName: 'HTTP拨测任务1',
    probeName: '广州',
    alertLevel: 'info',
    content: 'HTTP响应时间较慢，超过2000ms',
    created_at: '2025-08-21 14:20:00'
  },
  {
    id: 4,
    taskName: 'HTTP拨测任务1',
    probeName: '深圳',
    alertLevel: 'critical',
    content: 'HTTP连接失败，无法建立连接',
    created_at: '2025-08-21 14:15:00'
  },
  {
    id: 5,
    taskName: 'HTTP拨测任务1',
    ...
    alertLevel: 'warning',
    content: 'HTTP证书即将过期',
    created_at: '2025-08-21 14:10:00'
  }
])
...
const alertsByRegion = computed(() => {
  ...
  mockAlertData.value.forEach(alert => {
...
const updateWebStatusChart = () => {
  ...
  aggregatedResults.value.forEach(item => {
