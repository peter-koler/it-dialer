...
export const getSystemVariables = (params) => {
  return request.get('/api/v1/system/variables', { params })
}
...
export const createSystemVariable = (data) => {
  return request.post('/api/v1/system/variables', data)
}
...
export const updateSystemVariable = (id, data) => {
  return request.put(`/api/v1/system/variables/${id}`, data)
}
...
export const deleteSystemVariable = (id) => {
  return request.delete(`/api/v1/system/variables/${id}`)
}
<template>
